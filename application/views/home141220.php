                ...
                <div class="col-xl-5 col-lg-6 desktop-center-item">
                    <div class="desktop-center-area wow animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
                        <div class="section-title style-two">
                            <h2 class="title">What is <span>Accendon?</span></h2>
                            <p>Accendon One of the best Software Development company. Accendon is at the forefront as the most innovative web development company. Our cost efficient and structured teamwork justifies our position.</p>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
