                    ...
                    <div class="footer-widget widget text-center">
                        <div class="footer_top_widget">
                            <a href ="<?= base_url()?>" class="footer-logo">
                                <img src="<?=assets('assets/img/logo.png')?>" alt="footer logo">
                            </a>
                        ...
                        <div class="row custom-gutters-16">
                            <div class="col-lg-7">
                                <div class="copyright-text">
                                    &copy; Accendon <?= date("Y") ?> All rights reserved
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <ul class="social-icon text-right">
                                    ...
                                    <li>
                                        <a class="linkedin" href="https://www.linkedin.com/company/accendon-technologies/" target="_blank"><i class="fa fa-linkedin-square"></i></a>
                                    </li>
                                    <!-- <li>
