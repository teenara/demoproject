                        ...
                        <div class="col-lg-6 col-md-6 hidden-sm">
                            <div class="banner-thumb-wrap">
                                <div class="banner-thumb">
                                    <img class="header-inner-img"
                                        src="assets/img/wellnessImages/BannerImages/ayurveda001.png" alt="banner-img">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="banner-slider-item">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 hidden-sm">
                            <div class="banner-thumb-wrap">
                                <div class="banner-thumb">
                                    <img class="header-inner-img" src="assets/img/wellnessImages/BannerImages/diet.png"
                                        alt="banner-img">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 hidden-sm">
                            <div class="banner-thumb-wrap">
                                <div class="banner-thumb">
                                    <img class="header-inner-img"
                                        src="assets/img/wellnessImages/BannerImages/fitness.png" alt="banner-img">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row custom-gutters-16">
                <div class="col-xl-3 col-md-6 col-sm-6">
                    <div class="single-service">
                        ...
                        <p>Get score of your wellness as
                            well as sub score of individual aspects of
                            wellness. so you can identify your overall
                            health and aspects requiring attention to improve.</p>
                ...
                <div class="col-xl-3 col-md-6 col-sm-6">
                    <div class="single-service">
                        ...
                        <p>Based on an assessment and analysis of your lifestyle and habits, we give you a detailed
                            wellness report, the manual for your whole system.<br>
                        </p><br>
                        <div class="read-more">
                            <a href="#"><img src="assets/img/service/arrow.png" alt="arrow"></a>
                        </div>
                ...
                <div class="col-xl-3 col-md-6 col-sm-6">
                    <div class="single-service">
                        ...
                        <p>We provide highly custom-designed wellness packages meant for specic cases such as pregnant
                            women, nursing mothers, elderly people, those who suer chronic diseases like cancer or life
                            style diseases such as diabetes. </p>
                        <div class="read-more">
                            <a href="#"><img src="assets/img/service/arrow.png" alt="arrow"></a>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-md-6 col-sm-6">
                    <div class="single-service">
                        ...
                        <p>A unique approach to assessment of human resources, we assess the physical, mental and
                            emotional wellness of candidates to examine their tness and suitability for a given career
                            or job.
                        </p><br><br>
                        <div class="read-more">
                            <a href="#"><img src="assets/img/service/arrow.png" alt="arrow"></a>
                ...
                <div class="col-xl-3 col-md-6 col-sm-6">
                    <div class="single-service">
                        ...
                        <p>We provide time tested and safe home remedies using items that are common to every household.
                            We also provide personalised beauty care that ts the body nature of a person ensuring the
                            eects and benets last longer.
                        </p>
                        <div class="read-more">
                            <a href="#"><img src="assets/img/service/arrow.png" alt="arrow"></a>
                        </div>
                    ...
                    <div class="desktop-center-area wow animated fadeInLeft" data-wow-duration="1s"
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="riyaqas-check-list media">
                                    <img class="media-left" src="assets/img/icons/check.svg" alt="check">
                                    <span>Diet score: Know your present wellness diet status.</span>
                                </div>
                                <div class="riyaqas-check-list media">
                                    <img class="media-left" src="assets/img/icons/check.svg" alt="check">
                                ...
                                <div class="riyaqas-check-list media mg-bottom-0-991">
                                    <img class="media-left" src="assets/img/icons/check.svg" alt="check">
                                    <span>Weekly diet reports: gradually supports you to get maximum wellness from your
                                        diet. These diet reports will help the user to maintain a balanced diet.</span>
                                </div>
                                <div class="riyaqas-check-list media mg-bottom-0-991">
                                    <img class="media-left" src="assets/img/icons/check.svg" alt="check">
                                    <span>Wellness diet: Healthy food creates a healthy mind.</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="riyaqas-check-list-wrap">
                                            ...
                                            <div class="riyaqas-check-list media">
                                                <img class="media-left" src="assets/img/icons/check3.svg" alt="check">
                                                <span>They can activate T and B lymphocytes to fight against
                                                    diseases.</span>
                                            </div>
                                            <div class="riyaqas-check-list media">
                                                <img class="media-left" src="assets/img/icons/check3.svg" alt="check">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <div class="riyaqas-check-list-wrap">
                                            ...
                                            <div class="riyaqas-check-list media">
                                                <img class="media-left" src="assets/img/icons/check3.svg" alt="check">
                                                <span> Strong bones and muscle power.</span>
                                            </div>
                                            <div class="riyaqas-check-list media">
                                                <img class="media-left" src="assets/img/icons/check3.svg" alt="check">
                        ...
                        <div class="gallery-masonry row no-gutters">
                            <div class="col-md-4 col-sm-6 masonry-item business ">
                                <a class="single-work-item text-center" data-effect="mfp-zoom-in"
                                    href="assets/img/index_1/Pregnancy_Diet_1.png">
                                    <span class="thumb">
                            ...
                            <div class="col-md-4 col-sm-6 masonry-item  business">
                                <a class="single-work-item text-center" data-effect="mfp-zoom-in"
                                    href="assets/img/index_1/Pregnancy_Diet_2.png">
                                    <span class="thumb">
                            ...
                            <div class="col-md-4 col-sm-6 masonry-item finance">
                                <a class="single-work-item text-center" data-effect="mfp-zoom-in"
                                    href="assets/img/index_1/Sports_Diet_1.png">
                                    <span class="thumb">
                            ...
                            <div class="col-md-4 col-sm-6 masonry-item finance">
                                <a class="single-work-item text-center" data-effect="mfp-zoom-in"
                                    href="assets/img/index_1/Sports_Diet_2.png">
                                    <span class="thumb">
                            ...
                            <div class="col-md-4 col-sm-6 masonry-item  technology">
                                <a class="single-work-item text-center" data-effect="mfp-zoom-in"
                                    href="assets/img/index_1/Brain_Stimulating_Diet_1.png">
                                    <span class="thumb">
                            ...
                            <div class="col-md-4 col-sm-6 masonry-item technology ">
                                <a class="single-work-item text-center" data-effect="mfp-zoom-in"
                                    href="assets/img/index_1/Brain_Stimulating_Diet_2.png">
                                    <span class="thumb">
                    ...
                    <div class="col-xl-11">
                        <ul class="software-store-wrap">
                            <li>
                                <a href="#" class="single-software-store text-center">
                                    <div class="thumb">
                                        <img src="assets/img/wellnessImages/optimumFitness_icons/immuneBoosting.png"
                                            alt="img">
                                    </div>
                            ...
                            <li>
                                <a href="#" class="single-software-store text-center">
                                    <div class="thumb">
                                        <img src="assets/img/wellnessImages/optimumFitness_icons/shape_beauty.png"
                                            alt="img">
                                    </div>
                            ...
                            <li>
                                <a href="#" class="single-software-store text-center">
                                    <div class="thumb">
                                        <img src="assets/img/wellnessImages/optimumFitness_icons/weightManagement.png"
                                            alt="img">
                                    </div>
                            ...
                            <li>
                                <a href="#" class="single-software-store text-center">
                                    <div class="thumb">
                                        <img src="assets/img/wellnessImages/optimumFitness_icons/balancedActivatedLifestyle.png"
                                            alt="img">
                                    </div>
                            ...
                            <li>
                                <a href="#" class="single-software-store text-center">
                                    <div class="thumb">
                                        <img src="assets/img/wellnessImages/optimumFitness_icons/Rejuvanation.png"
                                            alt="img">
                                    </div>
                            ...
                            <li>
                                <a href="#" class="single-software-store text-center">
                                    <div class="thumb">
                                        <img src="assets/img/wellnessImages/optimumFitness_icons/strengthBuilding.png"
                                            alt="img">
                                    </div>
                            ...
                            <li>
                                <a href="#" class="single-software-store text-center">
                                    <div class="thumb">
                                        <img src="assets/img/wellnessImages/optimumFitness_icons/antiAging.png"
                                            alt="img">
                                    </div>
                                    <h4><br>Anti Aging</h4>
                                </a>
                            ...
                            <li>
                                <a href="#" class="single-software-store text-center">
                                    <div class="thumb">
                                        <img src="assets/img/wellnessImages/optimumFitness_icons/muscleBuilding.png"
                                            alt="img">
                                    </div>
                            ...
                            <li>
                                <a href="#" class="single-software-store text-center">
                                    <div class="thumb">
                                        <img src="assets/img/wellnessImages/optimumFitness_icons/stressManagement.png"
                                            alt="img">
                                    </div>
                                        ...
                                        <div class="riyaqas-check-list-wrap">
                                            ...
                                            <div class="riyaqas-check-list media">
                                                ...
                                                <span> Amidst the trend of recorded workout videos, we choose to focus
                                                    on providing Live Training on:• Yoga • Zumba • Cardiac Exercise •
